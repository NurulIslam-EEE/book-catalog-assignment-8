...
router.patch("/:id", category_controller_1.CategoryController.updateSingleCategory);
router.delete("/:id", category_controller_1.CategoryController.deleteSingleCategory);
